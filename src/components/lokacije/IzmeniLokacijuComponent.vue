<template>
  <div class="d-flex justify-content-center" style="height:100%">
    <div class="w-md-50">
      ...
      <h3 class="display-4 mb-5">Izmeni Lokaciju</h3>
      <div class="container">
        <div class="row mb-2">
...
import sveLokacije from '../../components/lokacije/SveLokacijeComponent';
...
export default {
  ...
  methods: {
        izmeni() {
            lokacijaService.editLokacija(this.lokacija, this.$route.params.id)
            .then((res) => {
                this.$toastr.s ('Lokacija je izmenjena.', "Lokacija izmenjena!");
                this.$router.go('/');
  ...
  created() {
        lokacijaService.getLokacijaById(this.$route.params.id)
        .then((res) => {
